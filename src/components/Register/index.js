    ...
    return(
      <div>
        ...
        <form onSubmit={this.register} id="register">
          ...
          onChange={(e) => this.setState({nome: e.target.value})} placeholder="Emanuele Correa"/><br/>

          <label>Email:</label><br/>
          <input type="text" value={this.state.email} autoComplete="off"
          onChange={(e) => this.setState({email: e.target.value})} placeholder="manu@teste.com"/><br/>
